    ...
    for arr_n in range(0, len(arrays)):
        ...
        for neighbors in range(1, 10):
            ...
            for r_state in range(1, 10):
                ...
                average_acc4 = average_acc2 + count_pipe_knn(arrays[arr_n], r_state, neighbors, 'uniform')
                average_acc5 = average_acc3 + count_pipe_knn(arrays[arr_n], r_state, neighbors, 'distance')
        ...
        for estimator in range(1, 20):
            ...
            file.write(
                str(average_acc7) + '\tforest_pipe' + '\tn_arr: ' + str(arr_n) + '\testimator = ' + str(estimator) + '\n')
            file.flush()
