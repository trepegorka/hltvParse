...
public class HltvBuilder {
    ...
    public static void start() throws Exception {
        ...
        Document hltvMainDoc = getHtml("https://www.hltv.org"); //1
        for (String matchLink : hltv.liveMatches(hltvMainDoc)) {
            ...
            System.out.println(hltv.getTeamLink1(matchDoc).substring(hltv.getTeamLink1(matchDoc).lastIndexOf("/") + 1) + "  " +
                    "vs  " + hltv.getTeamLink2(matchDoc).substring(hltv.getTeamLink2(matchDoc).lastIndexOf("/") + 1));
            for (String map : hltv.mapPick(matchDoc)) {
                ...
                System.out.println();
                System.out.println(map+" "+"Rating   DPR    KAST   IMPT    ADR   KPR    HS %    K/DRat  O/KRat  WinFB");
                System.out.println("" + map + " " + calc1);
